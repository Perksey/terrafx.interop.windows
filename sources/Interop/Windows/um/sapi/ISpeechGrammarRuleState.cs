...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct ISpeechGrammarRuleState
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int AddSpecialTransition([NativeTypeName("ISpeechGrammarRuleState *")] ISpeechGrammarRuleState* DestinationState, SpeechSpecialTransitionType Type, [NativeTypeName("const BSTR")] ushort* PropertyName = (ushort*)(""), [NativeTypeName("long")] int PropertyId = 0, [NativeTypeName("VARIANT *")] VARIANT* PropertyValue = null, float Weight = 1)
        {
